        ...
        if (empty($errors)) {
            try {
                ...
                if ($success) {
                    ...
                    // Gamification kontrolü - eğer gamification.php varsa
                    if (file_exists('includes/gamification.php')) {
                        require_once 'includes/gamification.php';
                        
                        // Puan ekle
                        addPoints($userId, 5, 'transaction_added');
                        ...
                        if (!empty($newAchievements)) {
                            $achievementNames = array_map(function($a) { return $a['name']; }, $newAchievements);
                            $achievementMessage = ' Yeni başarılar: ' . implode(', ', $achievementNames);
                        }
                    }
