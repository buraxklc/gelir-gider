...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">
            <i class="bi bi-currency-exchange"></i> Güncel Döviz Kurları
        </h5>
        <small class="text-muted">Son Güncelleme: <?= date('d.m.Y H:i', strtotime($exchangeRates['USD']['updated_at'])) ?></small>
    </div>
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4 mb-2">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <strong><?= e($code) ?></strong> - <?= e($rate['name']) ?>
                    </div>
                    <div>
                        <span class="badge bg-success">Alış: <?= number_format($rate['buying'], 4) ?> ₺</span>
                        <span class="badge bg-danger">Satış: <?= number_format($rate['selling'], 4) ?> ₺</span>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
