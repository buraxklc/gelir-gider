                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0"><?= e($transaction['category_name']) ?></p>
                        </div>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="edit-recurring-transaction.php?id=<?= $transaction['id'] ?>">
                                        <i class="bi bi-pencil"></i> Düzenle
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="toggle-recurring-transaction.php?id=<?= $transaction['id'] ?>">
                                        <i class="bi bi-pause-circle"></i> 
                                        <?= $transaction['is_active'] ? 'Duraklat' : 'Aktifleştir' ?>
                                    </a>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <a class="dropdown-item text-danger" href="delete-recurring-transaction.php?id=<?= $transaction['id'] ?>"
                    ...
                    <div class="mb-3">
                        <h4 class="mb-0 <?= $transaction['type'] == 'income' ? 'text-success' : 'text-danger' ?>">
                    ...
                    <div class="mb-2">
                        ...
                        <strong><?= date('d.m.Y', strtotime($transaction['next_occurrence'])) ?></strong>
                        <?php
                        ...
                        <?php elseif ($daysUntil <= 7): ?>
                            <span class="badge bg-primary"><?= $daysUntil ?> gün sonra</span>
                        <?php endif; ?>
                    </div>
                    
                    <?php if ($transaction['bank_account_name']): ?>
                    <div class="mb-2">
                        <small class="text-muted">Banka Hesabı:</small>
                        <small><?= e($transaction['bank_account_name']) ?></small>
                    </div>
                    <?php endif; ?>
