        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <th>Mevcut Bakiye:</th>
                        <td><strong><?= formatMoney($account['current_balance'], $currency) ?></strong></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <table class="table">
                    <tr class="table-light">
                        ...
                        <td class="text-end"><?= formatMoney($startBalance, $currency) ?></td>
                    </tr>
                    <tr>
                        <th>Toplam Para Yatırma</th>
                        <td class="text-end text-success">+ <?= formatMoney($totalDeposits, $currency) ?></td>
                    </tr>
                    <tr>
                        <th>Toplam Para Çekme</th>
                        <td class="text-end text-danger">- <?= formatMoney($totalWithdrawals, $currency) ?></td>
                    </tr>
                    <tr>
                        <th>Toplam Banka Ücreti</th>
                        <td class="text-end text-danger">- <?= formatMoney($totalFees, $currency) ?></td>
                    </tr>
                    <tr>
                        <th>Toplam Faiz</th>
                        <td class="text-end text-success">+ <?= formatMoney($totalInterest, $currency) ?></td>
                    </tr>
                    <tr class="table-light">
                        <th>Dönem Sonu Bakiye</th>
                        <td class="text-end"><strong><?= formatMoney($endBalance, $currency) ?></strong></td>
                   </tr>
               </table>
           </div>
           <div class="col-md-6">
                   ...
                   <tbody>
                       ...
                       <tr>
                           ...
                           <td class="text-end">
                               ...
                               $sign = $isCredit ? '+' : '-';
                               ?>
                               <span class="<?= $class ?>"><?= $sign ?><?= formatMoney($transaction['amount'], $currency) ?></span>
                           </td>
                           <td class="text-end"><?= formatMoney($transaction['balance_after'], $currency) ?></td>
