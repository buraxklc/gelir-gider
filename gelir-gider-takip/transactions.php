...
// Filtreleri al
$startDate = $_GET['start_date'] ?? date('Y-m-01'); // Mevcut ayın başlangıcı
$endDate = $_GET['end_date'] ?? date('Y-m-t'); // Mevcut ayın sonu
$type = $_GET['type'] ?? '';
    ...
    <div class="mt-3">
        <div class="dropdown d-inline-block">
            ...
            <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                <li><a class="dropdown-item" href="export.php?format=csv&type=<?php echo $type; ?>&category_id=<?php echo $categoryId; ?>&start_date=<?php echo $startDate; ?>&end_date=<?php echo $endDate; ?>">CSV</a></li>
                <li><a class="dropdown-item" href="export.php?format=excel&type=<?php echo $type; ?>&category_id=<?php echo $categoryId; ?>&start_date=<?php echo $startDate; ?>&end_date=<?php echo $endDate; ?>">Excel</a></li>
                <li><a class="dropdown-item" href="export.php?format=pdf&type=<?php echo $type; ?>&category_id=<?php echo $categoryId; ?>&start_date=<?php echo $startDate; ?>&end_date=<?php echo $endDate; ?>">PDF</a></li>
            </ul>
        </div>
