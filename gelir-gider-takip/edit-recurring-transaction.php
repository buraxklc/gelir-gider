...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $data = [
        ...
        'end_date' => !empty($_POST['end_date']) ? $_POST['end_date'] : null, // ✅ Değişiklik burada
...
<div class="col-md-4">
    ...
    <input type="date" class="form-control" id="end_date" name="end_date" 
           value="<?= e($transaction['end_date'] ?? '') ?>">
    <small class="text-muted">Boş bırakın = Süresiz tekrar</small>
</div>
